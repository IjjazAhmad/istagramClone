      ...
      <ScrollView >
        ...
        <View style={[styles.horizantalyCenter]}>
          <View style={{ display: "flex", flexDirection: "row", marginVertical: 30 }}>
            ...
            <Text style={authstyles.textBold} onPress={handleGoogleSignin}>Login with Google</Text>
          </View>
          ...
          <View style={{ marginVertical: 30 }}>
            <Text style={[authstyles.text]}>Don't have an account.<Text style={authstyles.forget} onPress={() => { navigation.navigate(AUTH_STACK_SCREEN.SIGNUP) }} >Sign up.</Text></Text>
          </View>
        </View>
      </ScrollView>
    </View>
